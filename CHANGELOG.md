...
### Changed
- Upgraded `jsv` to `0.21.2`, moving the schema stack to Decimal 3.
- Upgraded `stream_data` to `1.4.0` and refreshed the complete Hex lock graph.

## [0.3.1] - 2026-04-23

### Changed
- Upgraded the direct `jsv` dependency to `0.18.3`.
- Bumped the package and documentation version references to `0.3.1`.
...
[0.3.2]: https://github.com/nshkrdotcom/sinter/releases/tag/v0.3.2
[0.3.1]: https://github.com/nshkrdotcom/sinter/releases/tag/v0.3.1
